...
abstract class AppLocalizations {
  ...
  /// No description provided for @customersDuplicatePhoneTitle.
  ///
  /// In en, this message translates to:
  /// **'Phone already used'**
  String get customersDuplicatePhoneTitle;

  /// No description provided for @customersDuplicatePhoneCreateAnyway.
  ///
  /// In en, this message translates to:
  /// **'Create anyway'**
  String get customersDuplicatePhoneCreateAnyway;

  /// No description provided for @customersDuplicatePhoneChange.
  ///
  /// In en, this message translates to:
  /// **'Change'**
  String get customersDuplicatePhoneChange;
  ...
  /// No description provided for @customersEnglishNameOnly.
  ///
  /// In en, this message translates to:
  /// **'English name must contain English characters only'**
  String get customersEnglishNameOnly;

  /// No description provided for @customersArabicNameOnly.
  ///
  /// In en, this message translates to:
