...
/// Journey-plan-style filters for GET /api/erp/deliveries. Edits local draft until **Apply**.
class DeliveriesFilterBottomSheet extends StatefulWidget {
  const DeliveriesFilterBottomSheet({super.key});

  @override
  State<DeliveriesFilterBottomSheet> createState() =>
      _DeliveriesFilterBottomSheetState();
}

class _DeliveriesFilterBottomSheetState
    extends State<DeliveriesFilterBottomSheet> {
  ...
  void didChangeDependencies() {
    ...
    _draftCustomerCode = s.deliveriesFilterCustomerCode;
    _draftDateFrom = s.deliveriesFilterDateFrom;
    _draftDateTo = s.deliveriesFilterDateTo;
  }
  ...
  Future<void> _apply() async {
    ...
    await cubit.applyDeliveriesFilters(
