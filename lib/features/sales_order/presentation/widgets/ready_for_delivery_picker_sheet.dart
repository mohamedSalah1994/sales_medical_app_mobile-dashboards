...
/// Bottom sheet: loads ready-for-delivery orders, search, returns selected [docEntry].
/// [customerCardCode]: when non-null (e.g. visit ERP card code), list is limited to that customer.
Future<int?> showReadyForDeliveryPicker(
  ...
  return showModalBottomSheet<int>(
    ...
    builder:
        (ctx) => _ReadyForDeliveryPickerBody(
          cubit: cubit,
...
class _ReadyForDeliveryPickerBody extends StatefulWidget {
  const _ReadyForDeliveryPickerBody({
    required this.cubit,
  ...
  @override
  State<_ReadyForDeliveryPickerBody> createState() =>
      _ReadyForDeliveryPickerBodyState();
}

class _ReadyForDeliveryPickerBodyState
    extends State<_ReadyForDeliveryPickerBody> {
  ...
  Future<void> _load() async {
    ...
    try {
      final list = await widget.cubit.loadSalesOrdersReadyForDelivery(
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: l10n.readyForDeliverySearchHint,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: _load,
                              child: Text(l10n.readyForDeliveryRetry),
                            ),
                          ],
                        ),
                      ),
