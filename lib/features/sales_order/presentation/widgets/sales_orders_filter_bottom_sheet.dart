...
/// Same UX as [DeliveriesFilterBottomSheet] for GET /api/erp/sales-orders.
class SalesOrdersFilterBottomSheet extends StatefulWidget {
  const SalesOrdersFilterBottomSheet({super.key, this.visitId});

  /// When set (e.g. visit detail), reload keeps this [visitId] query param.
  final String? visitId;

  @override
  State<SalesOrdersFilterBottomSheet> createState() =>
      _SalesOrdersFilterBottomSheetState();
}

class _SalesOrdersFilterBottomSheetState
    extends State<SalesOrdersFilterBottomSheet> {
  ...
  void didChangeDependencies() {
    ...
    _draftCustomerCode = s.ordersFilterCustomerCode;
    _draftDateFrom = s.ordersFilterDateFrom;
    _draftDateTo = s.ordersFilterDateTo;
  }
  ...
  Future<void> _apply() async {
    ...
    await cubit.applyOrdersFilters(
